...
var A2b;
(function (A2b) {
    let allCards = ["r0", "r1", "r1", "r2", "r2", "r3", "r3", "r4", "r4", "r5", "r5", "r6", "r6", "r7", "r7", "r8", "r8", "r9", "r9", "rR", "rR", "rA", "rA",
    ...
    function main() {
        let handKarten = parseInt(prompt("Wie viele Karten?"));
        let maxNumber = allCards.length;
        for (let i = 0; i < handKarten; i++) {
